...
namespace VarispeedDemo
{
    public partial class MainForm : Form
    {
        ...
        private void LoadFile()
        {
            ...
            speedControl = new VarispeedSampleProvider(reader, 100, new SoundTouchProfile(useTempo, true));
        }
        ...
        private void comboBoxModes_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                var useTempo = comboBoxModes.SelectedIndex == 1;
                speedControl.SetSoundTouchProfile(new SoundTouchProfile(useTempo, true));
            }
        }
    }
}
